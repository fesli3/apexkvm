#define GameVersion v3.0.2.14 //[Miscellaneous].GameVersion updated 2025/02/12
#define OFFSET_ENTITYLIST 0xa6f2a58 //[Miscellaneous].cl_entitylist updated 2025/02/12
#define OFFSET_LOCAL_ENT 0x216ffb8 //[Miscellaneous].LocalPlayer updated 2025/02/12
#define OFFSET_LOCAL_ENTITY_HANDLE 0x1816908 //[Miscellaneous].LocalEntityHandle updated 2025/02/12
#define OFFSET_NAME_LIST 0xd0baf50 //[Miscellaneous].NameList updated 2025/02/12
#define OFFSET_GLOBAL_VARS 0x18e5f20 //[Miscellaneous].GlobalVars updated 2025/02/12
 
#define OFFSET_LEVELNAME 0x18e6434 //[Miscellaneous].LevelName updated 2025/02/12
...
#define OFFSET_HOST_MAP 0x018015e0 + 0x58 //[ConVars].host_map + 0x58 updated 2025/02/12
...
#define OFFSET_NAME 0x0481 //[RecvTable.DT_BaseEntity].m_iName updated 2025/02/12
#define OFFSET_SIGN_NAME 0x0478 //[RecvTable.DT_BaseEntity].m_iSignifierName updated 2025/02/12
...
#define OFFSET_VIEWANGLES 0x2594 //[RecvTable.DT_Player].m_ammoPoolCapacity - 0x14 updated 2025/02/12
#define OFFSET_BREATH_ANGLES OFFSET_VIEWANGLES - 0x10 //updated 01/10/2024
#define OFFSET_OBSERVER_MODE 0x35E4 //[RecvTable.DT_LocalPlayerExclusive].m_iObserverMode updated 2025/02/12
#define OFFSET_OBSERVING_TARGET 0x34b0 //[RecvTable.DT_LocalPlayerExclusive].m_hObserverTarget updated 2024/09/30
#define OFFSET_IN_USE 0x074521d0 //[Buttons].in_use updated 2025/02/12
...
#define OFFSET_M_CUSTOMSCRIPTINT OFFSET_ITEM_ID //[RecvTable.DT_PropSurvival].m_customScriptInt updated 2025/02/12
...
#define HIGHLIGHT_SETTINGS 0xAE3BFC0 //[Miscellaneous].HighlightSettings updated 2025/02/12
#define HIGHLIGHT_TYPE_SIZE 0x34 //? updated 01/10/2024
#define OFFSET_CROSSHAIR_LAST OFFSET_VISIBLE_TIME + 0x8 //[Miscellaneous].CWeaponX!lastCrosshairTargetTime updated 2025/02/12
...
#define OFFSET_GRAPPLEACTIVED       0x2d90 //[RecvTable.DT_Player].m_grappleActive updated 2025/02/12
#define OFFSET_GRAPPLE              0x2d08 //[RecvTable.DT_Player].m_grapple updated 2025/02/12
#define OFFSET_GRAPPLEATTACHED      0x0048 //[RecvTable.DT_GrappleData].m_grappleAttached updated 2025/02/12
#define OFFSET_m_xp		    0x380c //[RecvTable.DT_Player].m_xp updated 2025/02/12
#define OFFSET_GRADE 0x0348 //[RecvTable.DT_BaseEntity].m_grade updated 2025/02/12
