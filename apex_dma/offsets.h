#define GameVersion v3.0.1.25 //[Miscellaneous].GameVersion updated 2025/02/25
#define OFFSET_ENTITYLIST 0xa6efce8 //[Miscellaneous].cl_entitylist updated 2025/02/25
#define OFFSET_LOCAL_ENT 0x216cfb8 //[Miscellaneous].LocalPlayer updated 2025/02/25
#define OFFSET_LOCAL_ENTITY_HANDLE 0x1814098 //[Miscellaneous].LocalEntityHandle updated 2025/02/25
#define OFFSET_NAME_LIST 0xd0b70d0 //[Miscellaneous].NameList updated 2025/02/25
#define OFFSET_GLOBAL_VARS 0x18e3600 //[Miscellaneous].GlobalVars updated 2025/02/25
 
#define OFFSET_LEVELNAME 0x18E3B14 //[Miscellaneous].LevelName updated 2025/02/25
...
#define OFFSET_HOST_MAP 0x018004e0 + 0x58 //[ConVars].host_map + 0x58 updated 2025/02/25
 
#define OFFSET_TEAM 0x0338 //[RecvTable.DT_BaseEntity].m_iTeamNum updated 2025/02/25
#define OFFSET_HEALTH 0x0328 //[RecvTable.DT_Player].m_iHealth updated updated 2025/02/25
...
#define OFFSET_ARMORTYPE 0x47e4 //[RecvTable.DT_Player].m_armorType updated updated 2025/02/25
...
#define OFFSET_VISIBLE_TIME 0x19f0 //[Miscellaneous].CPlayer!lastVisibleTime updated 2025/02/25
#define OFFSET_ZOOMING 0x1c41 //[RecvTable.DT_Player].m_bZooming updated 2025/02/25

#define OFFSET_VIEW_OFFSET 0x00e8 //[DataMap.C_BaseEntity].m_currentFrame.viewOffset updated 2024/09/18
#define OFFSET_ACTIVE_WEAPON 0x1928 + 0x0058 //[RecvTable.DT_Player].m_inventory + WeaponInventory_Client>activeWeapons updated 2025/02/25
...
#define OFFSET_OBSERVER_LIST 0xA6F1D08 //[ConVars].gamepad_aim_assist_melee + 0x20C8 updated 2025/02/25
...
#define OFFSET_IN_DUCK 0x0744dc08 //[Buttons].in_duck updated 2025/02/25
...
#define OFFSET_IN_JUMP 0x0744db10 //[Buttons].in_jump updated 2025/02/25
#define OFFSET_IN_TOGGLE_DUCK 0x0744da38 //[Buttons].in_toggle_duck updated 2025/02/25
...
#define OFFSET_IN_ATTACK 0x0744da18 //[Buttons].in_attack updated 2025/02/25
#define OFFSET_IN_ZOOM 0x0744dba0 //[Buttons].in_zoom updated 2025/02/25
#define OFFSET_IN_FORWARD 0x0744dc48 //[Buttons].in_forward updated 2025/02/25
#define OFFSET_IN_BACKWARD 0x0744dc70 //[Buttons].in_backward updated 2025/02/25
 
#define OFFSET_LIFE_STATE 0x0690 //[RecvTable.DT_Player].m_lifeState updated 2025/02/25
#define OFFSET_BLEED_OUT_STATE 0x27b8 //[RecvTable.DT_Player].m_bleedoutState updated 2025/02/25
 
#define OFFSET_ORIGIN 0x017c //[DataMap.C_BaseEntity].m_vecAbsOrigin updated 2025/01/08
#define OFFSET_BONES 0x0d88 + 0x48 //[RecvTable.DT_BaseAnimating].m_nForceBone + 0x48 updated 2025/02/25
#define OFFSET_STUDIOHDR 0xfd0 //[Miscellaneous].CBaseAnimating!m_pStudioHdr updated 2025/02/25
#define OFFSET_AIMPUNCH 0x2438 //[DataMap.C_Player].m_currentFrameLocalPlayer.m_vecPunchWeapon_Angle updated 2024/09/18
#define OFFSET_CAMERAPOS 0x1f40 //[Miscellaneous].CPlayer!camera_origin updated 2025/02/25
#define OFFSET_VIEWANGLES 0x2594 - 0x14 //[RecvTable.DT_Player].m_ammoPoolCapacity - 0x14 updated 2025/02/25
...
#define OFFSET_IN_USE 0x0744db80 //[Buttons].in_use updated 2025/02/25
 
#define OFFSET_MATRIX 0x11a350 //[Miscellaneous].ViewMatrix updated 2025/02/25
#define OFFSET_RENDER 0x744b150 //[Miscellaneous].ViewRender updated 2025/02/25
 
#define OFFSET_WEAPON 0x1994 //[RecvTable.DT_BaseCombatCharacter].m_latestPrimaryWeapons updated 2025/02/25
...
#define OFFSET_ZOOM_FOV 0x1630 + 0xB8 //[RecvTable.DT_WeaponX].m_playerData + m_curZoomFOV updated 2025/02/25
#define OFFSET_AMMO 0x15b0 //[RecvTable.DT_PropSurvival].m_ammoInClip updated 2025/02/25
 
//#define OFFSET_ITEM_GLOW 0x02f0 //m_highlightFunctionBits
#define OFFSET_ITEM_ID 0x15b4 //[RecvTable.DT_PropSurvival].m_customScriptInt updated 2025/02/25
#define OFFSET_MODELNAME 0x0030 //[DataMap.C_BaseEntity].m_ModelName updated 2024/09/18
#define OFFSET_M_CUSTOMSCRIPTINT OFFSET_ITEM_ID //[RecvTable.DT_PropSurvival].m_customScriptInt updated 2025/02/25
#define OFFSET_YAW 0x229C - 0x8 //[DataMap.C_Player].m_currentFramePlayer.m_ammoPoolCount - 0x8 updated 2025/02/12
...
#define OFFSET_GLOW_FIX 0x268 //updated 2025/02/25
...
#define HIGHLIGHT_SETTINGS 0xae39270 //[Miscellaneous].HighlightSettings updated 2025/02/25
#define HIGHLIGHT_TYPE_SIZE 0x34 //? updated 01/10/2024
#define OFFSET_CROSSHAIR_LAST OFFSET_VISIBLE_TIME + 0x19f8 //[Miscellaneous].CWeaponX!lastCrosshairTargetTime updated 2025/02/25
//#define OFFSET_CROSSHAIR_START 0x1958 //CPlayer!crosshairTargetStartTime updated 01/9/2024
#define OFFSET_INPUT_SYSTEM 0x1990640 //[Miscellaneous].InputSystem updated 2025/02/25 

#define OFFSET_SKYDIVE_STATE 0x4844 //[RecvTable.DT_Player].m_skydiveState updated 2025/02/25
#define OFFSET_GRAPPLEACTIVED       0x2d90 //[RecvTable.DT_Player].m_grappleActive updated 2025/02/25
#define OFFSET_GRAPPLE              0x2d08 //[RecvTable.DT_Player].m_grapple updated 2025/02/25
#define OFFSET_GRAPPLEATTACHED      0x0048 //[RecvTable.DT_GrappleData].m_grappleAttached updated 2025/02/25
#define OFFSET_m_xp		    0x380c //[RecvTable.DT_Player].m_xp updated 2025/02/25
