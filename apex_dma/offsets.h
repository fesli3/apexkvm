...
#define OFFSET_ENTITYLIST 0x6a44a68 //[Miscellaneous].cl_entitylist updated 2025/03/07
#define OFFSET_LOCAL_ENT 0x2684A38 //[Miscellaneous].LocalPlayer updated 2025/03/07
#define OFFSET_LOCAL_ENTITY_HANDLE 0x1aa336c //[Miscellaneous].LocalEntityHandle updated 2025/03/07
#define OFFSET_NAME_LIST 0x949eaa0 //[Miscellaneous].NameList updated 2025/03/07
...
#define OFFSET_HOST_MAP 0x01a8f430 + 0x58 //[ConVars].host_map + 0x58 updated 2025/03/07
 
#define OFFSET_TEAM 0x0338 //[RecvTable.DT_BaseEntity].m_iTeamNum updated 2025/02/25
#define OFFSET_HEALTH 0x0328 //[RecvTable.DT_Player].m_iHealth updated updated 2025/03/07
...
#define OFFSET_ARMORTYPE 0x47e4 //[RecvTable.DT_Player].m_armorType updated updated 2025/03/07
...
#define OFFSET_ZOOMING 0x1c41 //[RecvTable.DT_Player].m_bZooming updated 2025/03/07

#define OFFSET_VIEW_OFFSET 0x00e8 //[DataMap.C_BaseEntity].m_currentFrame.viewOffset updated 2024/09/18
#define OFFSET_ACTIVE_WEAPON 0x1928 + 0x0058 //[RecvTable.DT_Player].m_inventory + WeaponInventory_Client>activeWeapons updated 2025/03/07
...
#define OFFSET_OBSERVER_LIST 0x6a46a88  //[ConVars].gamepad_aim_assist_melee + 0x20C8 updated 2025/03/07
...
#define OFFSET_IN_FORWARD 0x03357d58 //[Buttons].in_forward updated 2025/03/07
#define OFFSET_IN_BACKWARD 0x03357d80 //[Buttons].in_backward updated 2025/03/07
 
#define OFFSET_LIFE_STATE 0x0690 //[RecvTable.DT_Player].m_lifeState updated 2025/03/07
#define OFFSET_BLEED_OUT_STATE 0x27b8 //[RecvTable.DT_Player].m_bleedoutState updated 2025/03/07
 
#define OFFSET_ORIGIN 0x017c //[DataMap.C_BaseEntity].m_vecAbsOrigin updated 2025/01/08
#define OFFSET_BONES 0x0d88 + 0x48 //[RecvTable.DT_BaseAnimating].m_nForceBone + 0x48 updated 2025/03/07
#define OFFSET_STUDIOHDR 0xfd0 //[Miscellaneous].CBaseAnimating!m_pStudioHdr updated 2025/03/07
#define OFFSET_AIMPUNCH 0x2438 //[DataMap.C_Player].m_currentFrameLocalPlayer.m_vecPunchWeapon_Angle updated 2024/09/18
#define OFFSET_CAMERAPOS 0x1f40 //[Miscellaneous].CPlayer!camera_origin updated 2025/03/07
#define OFFSET_VIEWANGLES 0x2594 - 0x14 //[RecvTable.DT_Player].m_ammoPoolCapacity - 0x14 updated 2025/03/07
...
#define OFFSET_MATRIX 0x11a350 //[Miscellaneous].ViewMatrix updated 2025/03/07
#define OFFSET_RENDER 0x3355258 //[Miscellaneous].ViewRender updated 2025/03/07
 
#define OFFSET_WEAPON 0x1994 //[RecvTable.DT_BaseCombatCharacter].m_latestPrimaryWeapons updated 2025/03/07
...
#define OFFSET_INPUT_SYSTEM 0x1c20e40 //[Miscellaneous].InputSystem updated 2025/03/07 

#define OFFSET_SKYDIVE_STATE 0x4844 //[RecvTable.DT_Player].m_skydiveState updated 2025/03/07
#define OFFSET_GRAPPLEACTIVED       0x2d90 //[RecvTable.DT_Player].m_grappleActive updated 2025/03/07
#define OFFSET_GRAPPLE              0x2d08 //[RecvTable.DT_Player].m_grapple updated 2025/03/07
#define OFFSET_GRAPPLEATTACHED      0x0048 //[RecvTable.DT_GrappleData].m_grappleAttached updated 2025/02/25
#define OFFSET_m_xp		    0x380c //[RecvTable.DT_Player].m_xp updated 2025/03/07
